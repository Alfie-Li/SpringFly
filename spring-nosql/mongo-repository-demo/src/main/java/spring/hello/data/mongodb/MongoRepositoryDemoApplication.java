package spring.hello.data.mongodb;
...
import spring.hello.data.mongodb.converter.MoneyReadConverter;
import spring.hello.data.mongodb.model.Coffee;
import spring.hello.data.mongodb.repository.CoffeeRepository;
